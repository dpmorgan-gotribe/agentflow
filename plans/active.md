...
ARCHIVED 2026-04-28 (verifier suite expansion; commit 9622ad3):
...
- feat-028 visual-parity-verifier — DOM-diff via data-kit-* + computed-style audit; 7-pattern classifier; one bug per (screen, pattern). KNOWN GAP: `.claude/skills/parity-verify/SKILL.md` skipped — folded into feat-029 scope
- Combined: 693 → 807 tests (+114)
-->
