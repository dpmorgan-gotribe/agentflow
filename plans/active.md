...
| bug-029-ui-kit-primitives-missing-data-kit-component | bug     | draft  | P1       | bug/ui-kit-primitives-missing-data-kit-component | feat-028 Phase 0 retrofit (data-kit-\* attribute forwarding on every primitive) was deferred; project ui-kits ship without it. parity-verify v2 reports 39+ "missing primitive" divergences that aren't real shell-stripping — the components render fine, they just lack the data-kit-component attr. Fix: /stylesheet auto-retrofit + bulk script for existing projects.                    |
