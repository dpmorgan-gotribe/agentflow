...
outcome: success
shipped-scope: "Patch 1 (openPerBugWorktree pre-flight detection); Patch 2 (scripts/audit-tracked-pycache.mjs NEW operator-facing dry-run+apply); Patch 3 (/new-project SKILL.md .gitignore template adds **/__pycache__/ + *.pyc + *.pyo); Patch 4 (bug-073 convergence-detector signature granularity) DEFERRED — Patch 1 catches upstream"
ship-commits: ["850df21", "7339b84"]
parent-plan: null
supersedes: null
superseded-by: null
